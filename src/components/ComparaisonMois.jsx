  ...
  return (
    <div className="analyse">
      ...
      <div className="analyse-card">
        ...
        <div className="comparaison-rows">
          {LIGNES.map((ligne) => {
            ...
            return (
              <div className="comparaison-row" key={ligne.cle}>
                <span className="comparaison-icon-badge">
                  <Icon name={ligne.icon} />
                </span>
                <div className="comparaison-row-body">
                  <span className="comparaison-row-label">{ligne.label}</span>
                  <span className="comparaison-row-sub">
